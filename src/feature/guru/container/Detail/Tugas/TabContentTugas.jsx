                        ...
                        <div className="card-body ">
                            <div className="flex flex-col gap-2">
                                <span className={`flex items-center gap-2 justify-center text-xs font-medium px-2 py-1 rounded ${checkDeadlineStatus(item?.deadlineAt).color}`}>
                                    <span>{checkDeadlineStatus(item?.deadlineAt).status}</span>
                                </span>
                                ...
                                <TemplateInfoRow
                                    ...
                                    data={[
                                        {
                                            label: 'Dibuat',
                                            value: formatDateToTime(item?.createdAt) + ' WIB'
                                        },
                                        {
                                            label: 'Batas Pengumpulan',
                                            value: formatDateToTime(item?.deadlineAt) + ' WIB'
                                        }
                                    ]} />


                                <button
                                    onClick={() => navigate('/guru/kelas/' + id + '/tugas/' + item?.id)}
